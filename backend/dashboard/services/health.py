...
class Health:
    ...
    def get_health(cluster):
        ...
        if cluster == "greatlakes":
            api_url = f"{os.getenv('GREATLAKES_SHIM_HEALTH')}/hpc/v0.1/cluster/shim"
            ...
            api_url = f"{os.getenv('ARMIS2_SHIM_HEALTH')}/hpc/v0.1/cluster/shim"
                        # Headers including the API key
            headers = {
                'accept': 'application/json',
            ...
            api_url = f"{os.getenv('LIGHTHOUSE_SHIM_HEALTH')}/hpc/v0.1/cluster/shim"
                        # Headers including the API key
            headers = {
                'accept': 'application/json',
